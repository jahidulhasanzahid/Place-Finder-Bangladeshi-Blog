        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basictwo">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('post') }}">Information post</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('managepost') }}">Manage Information</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basicone">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('photos') }}">Post Photos</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('managephotos') }}">Manage Photos</a>
                </li>
              </ul>
            </div>
          </li>

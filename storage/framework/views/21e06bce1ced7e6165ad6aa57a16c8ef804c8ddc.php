 <?php $__env->startSection('content'); ?>
                <!--conatin-->
                    <div class="col-md-12">
                      <div class="row">
                        <div class="col-md-3">
                         <?php echo $__env->make('frontend.division.extra.rajshahi-side-nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                        <div class="col-md-9">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide extra-slider-design" data-ride="carousel">
                          <ol class="carousel-indicators">
                            <?php $i = 1; ?>
                            <?php $__currentLoopData = $rajshahi_photo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                ...
                <!--conatin-->
                    <div class="col-md-12">
                      <div class="row">
                        ...
                        <?php echo $__env->make('frontend.division.extra.barishal-side-nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        ...
                        <div class="col-md-9">
                          ...
                          <div class="shadow p-3 mb-5 bg-white rounded">
                            ...
                            <h3>Historical Place Information of Barishal City</h3><hr>
                                ...
                                <div class="card">
                                  <div class="card-body">
                                    <div class="col-md-12">
                                      <div class="row">
                                        <div class="col-md-6">
                                          <h4><a href="<?php echo e(route('info.comment',str_slug($all_information->id))); ?>"><?php echo e($all_information->title); ?></a></h4>

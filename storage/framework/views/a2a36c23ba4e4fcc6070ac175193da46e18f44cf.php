...
<html>
    <head>
        <title>Basic Design Tutorial</title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <!--Css Style sheet link File-->
    ...
    <body>
        <!--navbar part-->
            <div class="container-flude">
                <div class="own-nav-bg-color">
                    <nav class="navbar navbar-expand-lg navbar-light">
                      <a class="navbar-brand" href="index.html">Place Finder</a>
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="visitor-forum.html">Forum</a>
                          </li>
                          <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="dhaka.html">Dhaka</a>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide extra-slider-design" data-ride="carousel">
                          ...
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                              <img class="d-block w-100" src="Images/four.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                              <img class="d-block w-100" src="Images/five.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                              <img class="d-block w-100" src="Images/one.jpg" alt="Third slide">
                            </div>
                              <div class="carousel-item">
                              <img class="d-block w-100" src="Images/three.jpg" alt="Four slide">
                            </div>
                            <div class="carousel-item">
                              <img class="d-block w-100" src="Images/two.jpg" alt="Five slide">
                            </div>
                          </div>
                    ...
                    <!-- Basic Information Part--->
                        <div class="card text-center">
                          ...
                          <div class="card-body">
                            ...
                            <hr>
                            <a href="#" class="btn btn-info">EXPLORE START</a>
                          </div>
                        </div>                      
                   <!--Basic Information Part-->
                <!--contain-->
            ...
            <!--footer-->
                <div class="card text-center own-nav-bg-color">
                    <div class="card-footer text-muted">
                        <p>&copy;Copyright <a href="https://www.facebook.com/meh.moho" target="_blank">Mohona</a>-><a href="https://www.facebook.com/sk.farhad.9">Farhad</a>-><a href="https://www.facebook.com/PicchiNobita">Jahidul</a></p>
                    </div>
                </div>
            <!--foooter-->
            
        
        <!--Javascript Stylesheet Like File-->

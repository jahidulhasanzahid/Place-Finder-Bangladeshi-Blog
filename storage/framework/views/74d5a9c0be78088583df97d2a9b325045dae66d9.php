                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="post" action="<?php echo e(route('information.update', $information->id)); ?>" enctype="multipart/form-data">
                        <?php echo $__env->make('backend.messages', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Post Title</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" name="title" value="<?php echo e($information->title); ?>" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <img src="<?php echo asset('images/informations/'.$information->image); ?>" width="100"> <br>
